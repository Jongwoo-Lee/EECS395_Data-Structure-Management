...
namespace DictionaryTests
{
    ...
    public class ConstantTest
    {
        ...
        public void RunConstantIntegerTest()
        {
            ...
            Assert.AreEqual(expression1Value, 5, "run method for constants is not returning the correct result: expected 5, got "+expression1Value);
        }
        ...
        public void RunConstantStringTest()
        {
            ...
            //evaluate SyntaxTrees
            object expression1Value = expression1.Run(dict);
            Assert.AreEqual(expression1Value, "foo", "run method for constants is not returning the correct result: expected \"foo\", got " + expression1Value);
        }
